	...
	<div class="span5">
		<div class="logo">
			<a href="./京华亿家/index.htm">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.gif" alt="璇璇心界"/>
			</a>
		</div>
	</div>
	<div class="span9">
...
<!-- 					<div class="newProductAd">
						 ...
						 <s:iterator value="newList">
						 		...
						 		<li>
									<a  target="_blank"><img src="${pageContext.request.contextPath}/<s:property  value="image"/>" data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg" style="display: block;"></a>									
								</li>
						 </s:iterator>
