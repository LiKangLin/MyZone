...
function change1(){
	var img = document.getElementById("checkloginImg");  //获取图片
						...
						<table>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" autocomplete="off"><img id="checkloginImg" class="checkloginImg" src="${pageContext.request.contextPath}/checkImg.action" title="点击更换验证码" onclick="change1()">
										<div class="title">
						                    <s:actionerror />
										</div>
										</span>
